...
def run_fastapi_app():
    ...
    def process_scraping(ticker: str, source: str, from_date: str, to_date: str):
        scraper_map = {
            ...
            'marketaux': scrape_from_marketaux, 'finnhub': scrape_from_finnhub
        }
...
st.markdown("This application fetches the latest news for a selected stock, analyzes the sentiment of each headline, and displays the results.")
with st.sidebar:
