...
st.set_page_config(page_title="Market Pulse Analyzer by Malav", page_icon="📈", layout="wide")
...
st.markdown("Powered by Streamlit & FastAPI | Data sourced from NewsAPI.org, FMP, and others.")